...
import { Palette, Globe, Info, ChevronRight } from 'lucide-react-native';
    ...
    <>
      <ScrollView className="flex-1 bg-background">
        <View className="p-6 gap-8">
          <View>
            <Text variant="label" className="text-muted-foreground uppercase tracking-wider mb-3">
            ...
            <View className="rounded-xl border border-border bg-card overflow-hidden">
              ...
              >
                <Palette size={22} className="text-foreground mr-3" />
              ...
              >
                <Globe size={22} className="text-foreground mr-3" />
                <View className="flex-1">
          ...
          <View>
            ...
            <View className="rounded-xl border border-border bg-card overflow-hidden">
              <View className="flex-row items-center p-4">
                <Info size={22} className="text-foreground mr-3" />
                <View className="flex-1">
